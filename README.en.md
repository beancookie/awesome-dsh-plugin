...
**472** plugins · [PRs welcome](#contributing)
...
- [dugujun3-cloud/dsh-creator-skills](https://github.com/dugujun3-cloud/dsh-creator-skills) - Creator and solo-business skill pack for Chinese content creators: 11 Agent Skills (user operations, solo business system, knowledge products, work bootstrap, diagnostics), mounted via a native DSH bundle on ctx.skills, zero deps, MIT.
