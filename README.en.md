...
- [fengchang618gmail/dsh-course-subtitles](https://github.com/fengchang618gmail/dsh-course-subtitles) - Fetch course video captions (DeepLearning.AI / YouTube / Bilibili / Coursera), merge them into whole sentences, translate line by line (EN/ZH) and generate bilingual section headings, then publish one Feishu doc per lesson; also exports a course home page outline into a single doc. All credentials are read from the environment or the harness credential store.
