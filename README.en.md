...
- [avdergh/poe2-exile-architect](https://github.com/avdergh/poe2-exile-architect) - Path of Exile 2 build research and generation: registers the headless Path of Building engine and knowledge base of a local checkout as four MCP servers for the Research, Create and Learning workflows.
