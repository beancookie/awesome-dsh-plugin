...
- [1420079678-ctrl/agent-body](https://github.com/1420079678-ctrl/agent-body) — 器官化插件层：插件以「器官」声明能力、感知与反射，神经冲动把命令路由给负责它的器官，反射弧零模型调用即命中执行，静默期把运行经历巩固成记忆卡，器官失败走「归因—处方—复检」闭环自愈。
